...
-(CGFloat)heightWithFontSize:(CGFloat)fontSize width:(CGFloat)width
{
    ...
    return  [self boundingRectWithSize:CGSizeMake(width, CGFLOAT_MAX) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attrs context:nil].size.height;
}
...
+ (NSString *)judgeHttp:(NSString *)imgStr{
    if ([imgStr containsString:@"http"]) {
        ...
        return [NSString stringWithFormat:@"%@%@",MMJF_ShareV.image_url,imgStr];
    }
}
