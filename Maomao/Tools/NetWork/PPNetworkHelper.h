...
typedef NS_ENUM(NSUInteger, MMJFNetworkType) {
    /// POST
    MMJFNetworkPOST,
    /// GET
    MMJFNetworkGET,
...
/// 请求成功的Block
typedef void(^PPHttpRequestSuccess)(MMJFBaseModel *baseModel);

/// 请求失败的Block
typedef void(^PPHttpRequestFailed)(MMJFBaseModel *baseModel);
